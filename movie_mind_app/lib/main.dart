...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadData() async {
    ...
    final topRated = await _tmdbService.getTopRated();
                      ...
                      TextSpan(
                        children: [
                          TextSpan(
                            text: 'Movie',
                            style: TextStyle(
                              color: Color(0xFF1D1D1F), // 极深灰黑色，代表数据与科技
                              fontSize: 28,
                              fontWeight: FontWeight.w800,
                              fontFamily: '.SF UI Display', // 使用系统无衬线体 (iOS) 或默认
                              letterSpacing: -0.5,
                            ),
                          ),
                          TextSpan(
                            text: 'Mind',
                            style: TextStyle(
                              color: Color(0xFF5856D6), // 靛蓝色 (Indigo)，代表思维与艺术
                              fontSize: 28,
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('DAILY PICK', style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 2)),
